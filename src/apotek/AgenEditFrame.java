 ...
 * @author BAYU
 */
public class AgenEditFrame extends javax.swing.JFrame {
    ...
    public void setDefaultData() {
        try {
            ...
            result = statement.executeQuery("SELECT * FROM agen WHERE id_agen = " + this.getId());
            if (result.next()) {
                name_textbox.setText(result.getString("nama"));
            } else {
                JOptionPane.showMessageDialog(null, "Data agen tidak ada! id = " + this.getId());
            }
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new AgenEditFrame().setVisible(true);
            }
        });
    }
