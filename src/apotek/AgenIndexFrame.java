...
//Apoteker Frame
import apotek.AgenCreateFrame;
import apotek.AgenEditFrame;
 ...
 * @author BAYU
 */
public class AgenIndexFrame extends javax.swing.JFrame {
    ...
    public void dataTable() {
        ...
        table.addColumn("No.");
        table.addColumn("ID Agen");
        table.addColumn("Nama");
        agen_data_table.setModel(table);
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost/apotek", "root", "");
            statement = con.createStatement();
            result = statement.executeQuery("SELECT * FROM agen");

            while (result.next()) {
                table.addRow(new Object[]{
                    i,
                    result.getString("id_agen"),
    ...
    private void initComponents() {
        ...
        agen_data_table.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        agen_data_table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
            ...
            new String [] {
                "Title 1", "Title 2", "Tittle 3"
            }
        ));
        jScrollPane1.setViewportView(agen_data_table);
    ...
    private void ubah_agen_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ubah_agen_btnActionPerformed
        ...
        if (agen_data_table.getSelectedRow() == -1) {
            ...
            AgenEditFrame editAgen = new AgenEditFrame();
            editAgen.setId(String.valueOf(agen_data_table.getValueAt(agen_data_table.getSelectedRow(), 1)));
            editAgen.setDefaultData();
