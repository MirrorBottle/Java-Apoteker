 ...
 * @author BAYU
 */
public class ApotekerCreateFrame extends javax.swing.JFrame {
    ...
    private void submit_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submit_btnActionPerformed
        ...
        if (name_textbox.getText().equals("")) {
            ...
            try {
                ...
                result = statement.executeQuery("SELECT * FROM apoteker WHERE email = '" + email + "'");
                if (result.next()) {
                    email_textbox.setText("");
                    email_validate.setText("Email Sudah Terdaftar!");
                } else {
                    statement.executeUpdate("INSERT INTO `apoteker` (`id_apoteker`, `nama`, `password`, `jenis_kelamin`, `alamat`, `email`, `no_telp`) VALUES (NULL, '" + name + "', '" + password + "', '" + gender + "', '" + address + "', '" + email + "', '" + phone + "');");
