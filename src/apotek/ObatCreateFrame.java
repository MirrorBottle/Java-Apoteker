...
public class ObatCreateFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        compotition_textarea = new javax.swing.JTextArea();
        ...
        compotition_textarea.setColumns(20);
        compotition_textarea.setFont(new java.awt.Font("Calibri", 0, 16)); // NOI18N
        compotition_textarea.setRows(5);
        jScrollPane1.setViewportView(compotition_textarea);
    ...
    private void submit_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submit_btnActionPerformed
        ...
        if (name_textbox.getText().equals("")) {
            ...
            merk_invalid_text.setText("Email wajib diisi!");
        } else if (compotition_textarea.getText().equals("")) {
            compotition_invalid_text.setText("Alamat wajib diisi!");
        } else {
            this.clearValidation();
            String nama_obat = name_textbox.getText();
            String merk_obat = merk_textbox.getText();
            String komposisi_obat = compotition_textarea.getText();
    ...
    private javax.swing.JTextArea compotition_textarea;
